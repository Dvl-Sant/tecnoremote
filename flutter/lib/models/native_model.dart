...
class PlatformFFI {
  ...
  TecnoremoteImpl get ffiBind => _ffiBind;
  ...
  Future<void> init(String appType) async {
    ...
    final dylib = isAndroid
        ? DynamicLibrary.open('libtecnoremote.so')
        : isLinux
            ? DynamicLibrary.open('libtecnoremote.so')
            : isWindows
                ? DynamicLibrary.open('libtecnoremote.dll')
                :
                ...
                //
                // isMacOS? DynamicLibrary.open("liblibtecnoremote.dylib") :
    ...
    try {
      ...
      _ffiBind = TecnoremoteImpl(dylib);
  ...
  void _startListenEvent(TecnoremoteImpl rustdeskImpl) {
    final appType =
